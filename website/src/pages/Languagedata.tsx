...
import {fetchMovieList,fetchMovieListLoadMore} from "../redux/action/moviesdataAction";
...
const Languagedata: FC<Props> = ({
  ...
  useEffect(() => {
    ...
    fetchMovieFilterDetail();
    // fetchLanguageApiFilterDetail(id,page,language,sort_by);
    fetchMovieLanguageFilterDetail();
  },[]);
  ...
  console.log("filter data=========", MovieFilterData);
                  ...
                  >
                    {MovieFilterData &&
                      ...
                      MovieFilterData.map((item: any, index: number) => {
                        return (
                          <Link className="dropdown-item" to={`/movies/${item.id}`}>
                            {item.name}
                          </Link>
                        );
                      })}
                  ...
                  >
                    {MovieLanguageFilterData &&
                      ...
                      MovieLanguageFilterData.map((item: any, index: number) => {
                        return (
                          <Link className="dropdown-item" to={`/movies/${item.english_name}`}>
                            {item.english_name}
                          </Link>
                        );
                      })}
...
const mapStateToProps = (state: any) => {
  return {
    ...
    MovieLanguageApiFilterData: state.LanguageFilterReducer.MovieFilterData,
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    ...
    // fetchLanguageApiFilterDetail: (id:any, page: number , language:any , sort_by :any) => dispatch(fetchLanguageApiFilterDetail(id,page,language,sort_by)),
    fetchMovieLanguageFilterDetail: () => dispatch(fetchMovieLanguageFilterDetail()),
    
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(Languagedata);
