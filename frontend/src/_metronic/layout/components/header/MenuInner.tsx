    ...
    <>
      ...
      >
        ...
        >
          ...
          <MenuItem to='/crafted/account/settings' title='Account' hasBullet={true} />
        </MenuInnerWithSub>
        ...
        <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        >
          <MenuItem to='/crafted/news/create' title='Create' hasBullet={true} />
          <MenuItem to='/crafted/news/list' title='List' hasBullet={true} />
        </MenuInnerWithSub>
      ...
      <MenuInnerWithSub title='Apps' to='/apps' menuPlacement='bottom-start' menuTrigger='click'>
        ...
        <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        >
          <MenuItem to='/apps/admin/category-page' title='Category Page' hasBullet={true} />
          <MenuItem to='/apps/admin/news-page' title='News Page' hasBullet={true} />
          <MenuItem to='/apps/admin/list-page' title='List Page' hasBullet={true} />
        </MenuInnerWithSub>
